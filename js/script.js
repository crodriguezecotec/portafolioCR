...
// =========================================
// Primera funcion: CONTADOR DE VISITAS (localStorage)
// =========================================
...
// =========================================
// Segunda funcion: ModoClaro (localStorage)
// =========================================
...
// =========================================
// Validacion de los datos de contacto
// =========================================
function validarFormulario(nombre, email, mensaje) {
    if (nombre.trim() === "" || email.trim() === "" || mensaje.trim() === "") {
        return {
            valido: false,
            texto: "Por favor completa todos los campos antes de enviar."
        };
    } else {
        return {
            valido: true,
            texto: "¡Gracias por tu mensaje, " + nombre + "! Te responderé pronto."
        };
    }
}
